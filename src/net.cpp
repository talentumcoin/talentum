...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Talentum " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"yhwh.talentum.io", "yhwh.talentum.io"},
    {"yhwhyrh.talentum.io", "yhwhyrh.talentum.io"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Talentum is probably already running."), addrBind.ToString().c_str());
        else
